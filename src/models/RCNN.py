...
class RCNN(nn.Module):
	def __init__(self, batch_size, output_size, hidden_size, vocab_size, embedding_length, weights):
		...
		#self.batch_size = int(batch_size / 4)
		...
		self.lstm = nn.LSTM(embedding_length, hidden_size, bidirectional=True) # batch_first must be false for multiple GPU
		#self.lstm = LayerNormLSTM(embedding_length, hidden_size, bidirectional=True)
